class Game {
  ...
  checkHandsAnswerCollision = (eachAnswerParam) => {
    if (this.hands.x < eachAnswerParam.x + eachAnswerParam.width &&
      ...
      this.hands.height + this.hands.y > eachAnswerParam.y) {
        ...
        // 1. check if iteration conter is 5
  ...
  gameLoop = () => {
    ...
    if ((
      ...
      //console.log(`main.js -> fillQuestionsAnswers() correctAnswer: ${correctRoundAnswer}`)
      ...
      this.answers.answersArr[0].y = this.answers.answer1Y + this.answers.answer1MovementSpeed;
      this.answers.answersArr[1].y = this.answers.answer2Y + this.answers.answer2MovementSpeed;
      this.answers.answersArr[2].y = this.answers.answer3Y + this.answers.answer3MovementSpeed;
      this.answers.answersArr[3].y = this.answers.answer4Y + this.answers.answer4MovementSpeed;
